...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    imageSrc: function imageSrc(link) {
      if (!link) return '';
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    field: {
      immediate: true,
      deep: true,
      handler: function handler(newField) {
        if (newField.value) {
          this.setInitialValue();
        }
      }
  ...
  methods: {
    notifyAutosaveChange: function notifyAutosaveChange(source) {
    ...
    setInitialValue: function setInitialValue() {
      if (this.field.value) {
        if (_typeof(this.field.value) === 'object') {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              files = event === null || event === void 0 || (_event$target = event.target) === null || _event$target === void 0 ? void 0 : _event$target.files;
              _context.next = 6;
    ...
    onDropzoneDragOver: function onDropzoneDragOver() {
      if (this.isUploading) return;
      this.isDraggingOverDropzone = true;
    },
    onDropzoneDragLeave: function onDropzoneDragLeave(event) {
      var _event$currentTarget;
      if (this.isUploading) return;
      // Снимаем подсветку только когда курсор реально ушёл из зоны
      if (!(event !== null && event !== void 0 && (_event$currentTarget = event.currentTarget) !== null && _event$currentTarget !== void 0 && _event$currentTarget.contains(event === null || event === void 0 ? void 0 : event.relatedTarget))) {
        this.isDraggingOverDropzone = false;
      }
    },
    onDropzoneDrop: function onDropzoneDrop(event) {
      var _this2 = this;
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              if (!_this2.isUploading) {
                _context2.next = 2;
                break;
              }
              return _context2.abrupt("return");
            case 2:
              _this2.isDraggingOverDropzone = false;
              files = event === null || event === void 0 || (_event$dataTransfer = event.dataTransfer) === null || _event$dataTransfer === void 0 ? void 0 : _event$dataTransfer.files;
              _context2.next = 6;
      ...
      return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 2:
              csrf = (_document$querySelect = document.querySelector('meta[name="csrf-token"]')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.getAttribute("content");
              candidates = Array.from(files).filter(function (f) {
                if (!f) return false;
                if (f.type && f.type.startsWith("image/")) return true;
                return /\.(png|jpe?g|webp|gif)$/i.test(f.name || "");
              });
              _this3.uploadingCount += candidates.length;
              _context4.next = 7;
              return Promise.allSettled(candidates.map(/*#__PURE__*/function () {
                  ...
                  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        _context3.prev = 3;
                        _context3.next = 6;
                        return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/nova-vendor/medov/image-gallery/upload-image", formData);
                      case 6:
                        ...
                        _this3.notifyAutosaveChange("image-gallery-upload");
                        _context3.next = 14;
                        break;
                      case 11:
                        _context3.prev = 11;
                        _context3.t0 = _context3["catch"](3);
                        console.error("Ошибка загрузки файла:", _context3.t0);
                      case 14:
                        _context3.prev = 14;
                        _this3.uploadingCount = Math.max(0, _this3.uploadingCount - 1);
    ...
    imageSrc: function imageSrc(link) {
      if (!link) return '';
      if (link.startsWith('http')) return link;
      var base = (this.field.storageUrl || '/storage').replace(/\/$/, '');
      return base + '/' + link;
    },
    ...
    drop: function drop(index) {
      ...
      var movedItem = this.value.splice(this.draggedIndex, 1)[0];
    ...
    fill: function fill(formData) {
      ...
      if (_typeof(this.value) === 'object' && this.value !== null) {
        Object.entries(this.value).forEach(function (_ref2) {
          ...
          if (_typeof(val) === 'object' && val !== null) {
            Object.entries(val).forEach(function (_ref4) {
              var _ref5 = _slicedToArray(_ref4, 2),
                subKey = _ref5[0],
                subVal = _ref5[1];
              formData.append("".concat(_this4.field.attribute, "[").concat(key, "][").concat(subKey, "]"), subVal !== null && subVal !== void 0 ? subVal : '');
            });
          } else {
            formData.append("".concat(_this4.field.attribute, "[").concat(key, "]"), val !== null && val !== void 0 ? val : '');
          }
        });
      } else {
        var _this$value;
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_PanelItem, {
    ...
    value: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [$options.parsedValue.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($options.parsedValue, function (image, index) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: index,
          "class": "image-gallery-item"
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Изображение слева "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
          src: $options.imageSrc(image.link),
          "class": "image-gallery-preview"
        }, null, 8 /* PROPS */, _hoisted_3)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Данные справа "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [image.author ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_5, [_cache[0] || (_cache[0] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, "Автор:", -1 /* HOISTED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(image.author), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), image.description ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_6, [_cache[1] || (_cache[1] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("strong", null, "Описание:", -1 /* HOISTED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(image.description), 1 /* TEXT */)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]);
      }), 128 /* KEYED_FRAGMENT */))])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_7, "Нет изображений"))];
    }),
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["field"]);
}
...
var _hoisted_1 = ["tabindex", "aria-disabled"];
var _hoisted_2 = ["disabled"];
var _hoisted_3 = {
  "class": "upload-dropzone__title"
};
var _hoisted_4 = {
  "class": "image-gallery-list"
};
var _hoisted_5 = ["onDragstart", "onDrop"];
var _hoisted_6 = {
  "class": "image-gallery-container"
};
var _hoisted_7 = ["src"];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Упрощённая форма загрузки "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["upload-box", {
          'upload-box--disabled': $options.isUploading
        }]),
        role: "button",
        tabindex: $options.isUploading ? -1 : 0,
        "aria-disabled": $options.isUploading ? 'true' : 'false',
        onClick: _cache[0] || (_cache[0] = function () {
          return $options.onUploadButtonClick && $options.onUploadButtonClick.apply($options, arguments);
        }),
      ...
      }, _cache[9] || (_cache[9] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, "Выбрать файлы", -1 /* HOISTED */)]), 42 /* CLASS, PROPS, NEED_HYDRATION */, _hoisted_1), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        ref: "fileInput",
        type: "file",
        multiple: "",
        accept: "image/*",
      ...
      }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_2), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Большая зона drag&drop "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["upload-dropzone", {
          'upload-dropzone--dragover': $data.isDraggingOverDropzone,
          'upload-dropzone--uploading': $options.isUploading
        }]),
        onDragenter: _cache[4] || (_cache[4] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
          return $options.onDropzoneDragEnter && $options.onDropzoneDragEnter.apply($options, arguments);
        }, ["prevent"])),
        onDragover: _cache[5] || (_cache[5] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
          return $options.onDropzoneDragOver && $options.onDropzoneDragOver.apply($options, arguments);
        }, ["prevent"])),
        onDragleave: _cache[6] || (_cache[6] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
          return $options.onDropzoneDragLeave && $options.onDropzoneDragLeave.apply($options, arguments);
        }, ["prevent"])),
        onDrop: _cache[7] || (_cache[7] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
          return $options.onDropzoneDrop && $options.onDropzoneDrop.apply($options, arguments);
        }, ["prevent"]))
      }, [$options.isUploading ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        key: 0
      }, [_cache[10] || (_cache[10] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
        "class": "upload-dropzone__loader upload-dropzone__loader--yellow",
        "aria-hidden": "true"
      }, null, -1 /* HOISTED */)), _cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        "class": "upload-dropzone__loading-title"
      }, "Загрузка", -1 /* HOISTED */))], 64 /* STABLE_FRAGMENT */)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        key: 1
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.isDraggingOverDropzone ? 'Отпустите файлы — начнём загрузку' : 'Для загрузки перетащите файлы сюда или выберите их через кнопку выше'), 1 /* TEXT */), _cache[12] || (_cache[12] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        "class": "upload-dropzone__subtitle"
      }, "Поддерживается мультизагрузка", -1 /* HOISTED */))], 64 /* STABLE_FRAGMENT */))], 34 /* CLASS, NEED_HYDRATION */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Список изображений "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.value, function (image, index) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: image.link,
          "class": "image-gallery-item",
          draggable: "true",
          onDragstart: function onDragstart($event) {
            return $options.dragStart(index, $event);
          },
          onDragover: _cache[8] || (_cache[8] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {}, ["prevent"])),
          onDrop: function onDrop($event) {
            return $options.drop(index);
          }
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Перетаскивание "), _cache[14] || (_cache[14] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
          "class": "drag-handle"
          ...
          x2: "17",
          y2: "17"
        })])], -1 /* HOISTED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Изображение слева "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
          src: $options.imageSrc(image.link),
          "class": "image-gallery-preview"
        }, null, 8 /* PROPS */, _hoisted_7)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Данные справа "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          "onUpdate:modelValue": function onUpdateModelValue($event) {
            return image.description = $event;
          },
          placeholder: "Описание",
          "class": "image-gallery-input"
        }, null, 8 /* PROPS */, _hoisted_10), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, image.description]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
          type: "text",
          "onUpdate:modelValue": function onUpdateModelValue($event) {
            return image.author = $event;
          },
          placeholder: "Автор",
          "class": "image-gallery-input"
        }, null, 8 /* PROPS */, _hoisted_11), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, image.author]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
          onClick: function onClick($event) {
            return $options.removeImage(index);
          },
          "class": "image-gallery-btn-danger",
          title: "Удалить"
        ...
        })], -1 /* HOISTED */)])), 8 /* PROPS */, _hoisted_12)])], 40 /* PROPS, NEED_HYDRATION */, _hoisted_5);
      }), 128 /* KEYED_FRAGMENT */))])];
    }),
    _: 1 /* STABLE */
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n/* Список изображений */\n.image-gallery-list[data-v-0224618e] {\n  display: flex;\n  flex-direction: column;\n  gap: 10px;\n  margin-top: 10px;\n}\n\n/* Табличный стиль */\n.image-gallery-item[data-v-0224618e] {\n  display: flex;\n  align-items: flex-start;\n  border: 1px solid #ccc;\n  padding: 10px;\n  border-radius: 6px;\n  gap: 15px;\n  background: white;\n}\n\n/* Контейнер для изображения */\n.image-gallery-container[data-v-0224618e] {\n  width: 150px;\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n}\n\n/* Само изображение */\n.image-gallery-preview[data-v-0224618e] {\n  width: 100%;\n  max-width: 150px;\n  border-radius: 4px;\n  border: 1px solid #ccc;\n}\n\n/* Блок данных */\n.image-gallery-details[data-v-0224618e] {\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n  font-size: 14px;\n}\n.no-images[data-v-0224618e] {\n  color: #777;\n  font-size: 14px;\n  font-style: italic;\n}\n", ""]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_0___default()(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.upload-box[data-v-c023248a] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  padding: 10px;\n  border-radius: 4px;\n  font-weight: bold;\n  color: #1976d2;\n  cursor: pointer;\n  transition: border 0.3s;\n  border: 2px solid #1976d2;\n  width: 200px;\n  text-align: center;\n}\n.upload-box[data-v-c023248a]:hover {\n  border-color: #1565c0;\n}\n.upload-box--disabled[data-v-c023248a] {\n  opacity: 0.55;\n  cursor: not-allowed;\n  pointer-events: none;\n}\n.hidden-file-input[data-v-c023248a] {\n  display: none;\n}\n.upload-dropzone[data-v-c023248a] {\n  margin-top: 10px;\n  width: 100%;\n  min-height: 140px;\n  border-radius: 10px;\n  border: 2px dashed #c7c7c7;\n  background: #f3f4f6;\n  color: #6b7280;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  text-align: center;\n  transition: border-color 0.15s ease, background 0.15s ease, color 0.15s ease;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n          user-select: none;\n}\n.upload-dropzone--dragover[data-v-c023248a] {\n  border-color: #1976d2;\n  background: rgba(25, 118, 210, 0.08);\n  color: #1976d2;\n}\n.upload-dropzone__title[data-v-c023248a] {\n  font-weight: 700;\n  line-height: 1.2;\n}\n.upload-dropzone__subtitle[data-v-c023248a] {\n  margin-top: 6px;\n  font-size: 13px;\n  font-weight: 500;\n  opacity: 0.9;\n}\n.upload-dropzone__loader[data-v-c023248a] {\n  width: 28px;\n  height: 28px;\n  border-radius: 999px;\n  border: 3px solid currentColor;\n  border-top-color: transparent;\n  display: inline-block;\n  animation: upload-dropzone-spin-c023248a 0.8s linear infinite;\n}\n.upload-dropzone__loader--yellow[data-v-c023248a] {\n  color: #f5c542;\n}\n@keyframes upload-dropzone-spin-c023248a {\nto {\n    transform: rotate(360deg);\n}\n}\n.upload-dropzone__loading-title[data-v-c023248a] {\n  margin-top: 10px;\n  font-weight: 700;\n  color: #6b5a45;\n}\n.upload-dropzone--uploading[data-v-c023248a] {\n  cursor: progress;\n  border-style: solid;\n  border-color: #ddc8a4;\n  background: linear-gradient(180deg, #faf6ee 0%, #f5eddc 100%);\n  color: #7a654b;\n  pointer-events: none;\n}\n.image-gallery-list[data-v-c023248a] {\n  display: flex;\n  flex-direction: column;\n  gap: 15px;\n  margin-top: 10px;\n}\n.image-gallery-item[data-v-c023248a] {\n  display: flex;\n  align-items: center;\n  border: 1px solid #ccc;\n  padding: 10px;\n  border-radius: 6px;\n  gap: 15px;\n  background: white;\n}\n.image-gallery-container[data-v-c023248a] {\n  width: 200px;\n  align-self: flex-start;\n}\n.image-gallery-preview[data-v-c023248a] {\n  width: 100%;\n  max-width: 200px;\n  border-radius: 4px;\n  border: 1px solid #ccc;\n}\n.image-gallery-details[data-v-c023248a] {\n  display: flex;\n  flex: 1;\n  gap: 8px;\n  align-items: flex-start;\n  min-height: 88px;\n}\n.input-container[data-v-c023248a] {\n  display: flex;\n  flex-direction: column;\n  flex: 1;\n  gap: 8px;\n}\n.image-gallery-input[data-v-c023248a] {\n  padding: 8px;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  font-size: 14px;\n  width: 100%;\n}\n.image-gallery-btn-danger[data-v-c023248a] {\n  padding: 8px;\n  background-color: #e54839;\n  color: white;\n  border: none;\n  border-radius: 4px;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: 40px;\n  height: 40px;\n  transition: background-color 0.3s;\n  flex-shrink: 0;\n}\n.image-gallery-btn-danger[data-v-c023248a]:hover {\n  background-color: #c03d31;\n}\n.drag-handle[data-v-c023248a] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  cursor: grab;\n  padding: 8px 12px;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n          user-select: none;\n  color: #666;\n  margin: 0 2px;\n}\n.drag-handle svg[data-v-c023248a] {\n  width: 24px;\n  height: 24px;\n}\n@media (max-width: 768px) {\n.image-gallery-item[data-v-c023248a] {\n    position: relative;\n    flex-wrap: wrap;\n}\n.image-gallery-details[data-v-c023248a] {\n    flex-basis: 100%;\n    width: 100%;\n}\n.image-gallery-btn-danger[data-v-c023248a] {\n    position: absolute;\n    top: 10px;\n    right: 10px;\n}\n}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
Nova.booting(function (app, store) {
  app.component('index-image-gallery', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-image-gallery', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-image-gallery', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmedov_image_gallery"] = self["webpackChunkmedov_image_gallery"] || [];
