...
function render(_ctx, _cache) {
  return (vue.openBlock(), vue.createElementBlock("svg", {
    ...
    vue.createElementVNode("path", { d: "M5.507 4.048A3 3 0 0 1 7.785 3h8.43a3 3 0 0 1 2.278 1.048l1.722 2.008A4.533 4.533 0 0 0 19.5 6h-15c-.243 0-.482.02-.715.056l1.722-2.008Z" }),
