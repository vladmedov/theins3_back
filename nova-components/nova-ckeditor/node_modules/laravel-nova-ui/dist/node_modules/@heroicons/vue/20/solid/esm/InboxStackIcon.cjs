...
function render(_ctx, _cache) {
  return (vue.openBlock(), vue.createElementBlock("svg", {
    ...
    vue.createElementVNode("path", { d: "M1 14a1 1 0 0 1 1-1h4a1 1 0 0 1 .894.553l.448.894a1 1 0 0 0 .894.553h3.438a1 1 0 0 0 .86-.49l.606-1.02A1 1 0 0 1 14 13h4a1 1 0 0 1 1 1v2a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-2Z" })
  ]))
}
